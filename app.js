...
var clickedItem = document.getElementById("order"),
    ...
    listDozen = `<div id="" class="orderListItem">
    <div>${itemsAvailable[0].value}</div>
        </div>`,
    listOneTray = `<div id="onekg" class="orderListItem">
    <div>${itemsAvailable[1].value}</div>
    </div>`,
    listTwoTray = `<div id="twokg" class="orderListItem">
    <div>${itemsAvailable[2].value}</div>
        </div>`,
listTwoLtrs = `<div id="oneLtrs" class="orderListItem">
...
let placeOrder = () => {
    ...
    document.getElementById("order").contains(document.getElementById("Ghee")) ||
        document.getElementById("order").contains(document.getElementById("onekg"))  ||
        document.getElementById("order").contains(document.getElementById("twoKg"))  ||
document.getElementById("order").contains(document.getElementById("oneLtrs"))  ||
        ...
        orderCart.innerHTML = `<a href="https://wa.me/919773017917?text=${enTxt}">Kindly Deliver It</a>` : orderCart.innerText = "Cart Empty";
